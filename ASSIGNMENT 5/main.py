...
def browse_products(
    ...
    if sort_by in ['price', 'name']:
        ...
        result = sorted(result, key=lambda p: p[sort_by], reverse=is_descending)
    ...
    return {
        ...
        'limit': limit,
        'total_found': total,
        'total_pages': -(-total // limit),  # Efficient ceiling division
...
def search_orders(customer_name: str = Query(...)):
    ...
    if not results: return {'message': f'No orders found for: {customer_name}'}
